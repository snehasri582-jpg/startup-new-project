const defaultInvestorNotifications = [
  ...
  { 
    ...
    summary: "Yamini has shared a new Weekly Progress Report for their project Smart City IoT.",
    body: "A new progress report has been submitted by Yamini tracking the status of <strong>Smart City IoT</strong>. The report details the hardware deployment milestones, sensor network latency graphs, and firmware updates completed during Week 3.",
    student: { name: "Yamini", university: "IIT Delhi" },
  ...
  { 
    ...
    summary: "Upcoming meeting with Archana regarding HealthNest scheduled on April 5, 2026.",
    body: "A video pitch consultation session has been scheduled between you and the student founder Archana. The purpose of this meeting is to walk through the Business Model Canvas, financial projections, and custom funding requirement for their HealthNest remote health-kiosk system.",
    student: { name: "Archana", university: "Anna University" },
    time: "1 day ago", 
